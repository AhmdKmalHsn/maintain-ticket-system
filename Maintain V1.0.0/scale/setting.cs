...
namespace scale
{
    public partial class setting : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'mYDBDataSet5.UsersView' table. You can move, or remove it, as needed.
            if (Session.User_Id == "")
            {
            ...
            this.usersViewTableAdapter1.Fill(this.mYDBDataSet5.UsersView);
            textBox1.Text = Properties.Settings.Default.ServerConnectionString;
            ...
            DBName.Text = Properties.Settings.Default.serverTable;
        }
