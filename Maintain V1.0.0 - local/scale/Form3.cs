...
namespace scale
{
    public partial class Form3 : Form
    {
        ...
        void read(string where)
        {
            ...
            string q = "select top(1000) * from [TicketView] "+where+" order by id desc";//+" and id<"+i
        ...
        void counterset() {
            SqlCommand cmd = new SqlCommand("select count(*) from [TicketView] ", Session.sqlcon);
            SqlCommand cmd1 = new SqlCommand("select count(*) from [TicketView]  where [حالة الطلب] = N'تم اصلاحه'", Session.sqlcon);
            SqlCommand cmd2 = new SqlCommand("select count(*) from [TicketView]  where [حالة الطلب] = N'انتظار'", Session.sqlcon);
            SqlCommand cmd3 = new SqlCommand("select count(*) from [TicketView]  where [حالة الطلب] = N'جاري'", Session.sqlcon);
            SqlCommand cmd4 = new SqlCommand("select count(*) from [TicketView]  where [حالة الطلب] = N'ملغي'", Session.sqlcon);
            Session.sqlcon.Open();
        ...
        {
            string q = "select top(100) * from [TicketView]  order by id desc";//+" and id<"+i
        ...
        private void keydown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter) {
                string q = @"select * from [TicketView]"+
