...
namespace scale
{
    public partial class Worker : Form
    {
       ...
       // SqlDataAdapter adapt; 
        ...
        public Worker(int n,int i,string str1,string str2)
        {
            InitializeComponent();
            type = n;
...
, con);
            con.Open();
            cmd.Parameters.AddWithValue("@SectionName","عمال" ); 
        ...
        private void bunifuFlatButton2_Click(object sender, EventArgs e)
        {
            ...
            if (type == 1) {
                cmd = new SqlCommand("update [عمال] set"
                         + "[نوع العامل]=@val1,"
                         + "[ملاحظات]=@val2 where [كود العامل]=@id", con);
                con.Open();
            ...
            else
            {
                ...
                cmd = new SqlCommand("insert into [عمال]("
                     + "[نوع العامل],"
        ...
        private void Worker_Load_1(object sender, EventArgs e)
        {
